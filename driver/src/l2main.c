    ...
    )
{
    ...
    miniChars.DisableInterruptHandler = L2MiniportDisableInterrupt;
    miniChars.EnableInterruptHandler = L2MiniportEnableInterrupt;
    miniChars.InitializeHandler = L2MiniportInitialize;
    miniChars.HaltHandler = L2MiniportHalt;
    miniChars.HandleInterruptHandler = L2MiniportHandleInterrupt;
    miniChars.ISRHandler = L2MiniportIsr;
